...
const struct op_class_t global_op_class[] = {
	...
	/* 5G, 80M & 160M */
	OP_CLASS_ENT(128, BAND_ON_5G, OPC_BW80, 52, 20, 24, 28, 32, /*5*/36, 40, 44, 48, 52, 56, 60, 64, 68, 72, 76, 80, 84, 88, 92, 96,/*8*/ 100, 104, 108, 112, 116, 120, 124, 128, 132, 136, 140, 144, 149, 153, 157, 161, 165, 169, 173, 177, 181, 185, 189, 193, 197, 201, 205, 209, 213, 217, 221, 225),
