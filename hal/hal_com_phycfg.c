...
bool phy_chk_ch_setting_consistency(_adapter *adapter, u8 ch)
{
	...
	if (ch <= 14) {
		...
		if ((hal_data->current_channel_bw != CHANNEL_WIDTH_20) &&
			(hal_data->current_channel_bw != CHANNEL_WIDTH_40) &&
	...
	if (ch > 14) {
		...
		if ((hal_data->current_channel_bw != CHANNEL_WIDTH_20) &&
			(hal_data->current_channel_bw != CHANNEL_WIDTH_40) &&
			(hal_data->current_channel_bw != CHANNEL_WIDTH_80) &&
			(hal_data->current_channel_bw != CHANNEL_WIDTH_160) &&
			(hal_data->current_channel_bw != CHANNEL_WIDTH_80_80) &&
			(hal_data->current_channel_bw != CHANNEL_WIDTH_5) &&
			(hal_data->current_channel_bw != CHANNEL_WIDTH_10)) {
			rtw_warn_on(1);
			goto exit;
